...
[![PHP Version](https://badgen.net/packagist/php/ghostwriter/skeleton?color=777BB4)](https://www.php.net/supported-versions)
[![Packagist Downloads](https://badgen.net/packagist/dt/ghostwriter/skeleton?color=F28D1A)](https://packagist.org/packages/ghostwriter/skeleton)
...
[![Sponsors via GitHub](https://img.shields.io/github/sponsors/ghostwriter?label=Sponsor+@ghostwriter/skeleton&logo=GitHub+Sponsors)](https://github.com/sponsors/ghostwriter)
...
``` bash
composer require ghostwriter/skeleton
```
...
- [All Contributors](https://github.com/ghostwriter/skeleton/contributors)
